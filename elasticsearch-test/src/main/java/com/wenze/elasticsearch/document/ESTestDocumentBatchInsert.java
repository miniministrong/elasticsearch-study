...
public class ESTestDocumentBatchInsert {
  public static void main(String[] args) throws IOException {
    ...
    request.add(new IndexRequest().index("user").id("1006").source(XContentType.JSON, "name", "wangwu3", "age", 80, "sex", "男"));
    request.add(new IndexRequest().index("user").id("1007").source(XContentType.JSON, "name", "wangwu44", "age", 70, "sex", "男"));
